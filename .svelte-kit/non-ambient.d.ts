...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/about" | "/admin" | "/admin/categories" | "/admin/login" | "/admin/posts" | "/admin/posts/new" | "/api" | "/api/auth" | "/api/auth/login" | "/api/auth/logout" | "/api/categories" | "/api/comments" | "/api/donate" | "/api/posts" | "/api/seed-categories" | "/api/test-supabase" | "/api/upload" | "/api/users" | "/donate" | "/posts" | "/posts/[post_id]" | "/[category]";
		RouteParams(): {
		...
		Pathname(): "/" | "/about" | "/about/" | "/admin" | "/admin/" | "/admin/categories" | "/admin/categories/" | "/admin/login" | "/admin/login/" | "/admin/posts" | "/admin/posts/" | "/admin/posts/new" | "/admin/posts/new/" | "/api" | "/api/" | "/api/auth" | "/api/auth/" | "/api/auth/login" | "/api/auth/login/" | "/api/auth/logout" | "/api/auth/logout/" | "/api/categories" | "/api/categories/" | "/api/comments" | "/api/comments/" | "/api/donate" | "/api/donate/" | "/api/posts" | "/api/posts/" | "/api/seed-categories" | "/api/seed-categories/" | "/api/test-supabase" | "/api/test-supabase/" | "/api/upload" | "/api/upload/" | "/api/users" | "/api/users/" | "/donate" | "/donate/" | "/posts" | "/posts/" | `/posts/${string}` & {} | `/posts/${string}/` & {} | `/${string}` & {} | `/${string}/` & {};
