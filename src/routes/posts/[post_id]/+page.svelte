...
<div class="min-h-screen bg-white">
    ...
    <div class="relative">
            ...
            <div class="relative h-[60vh] min-h-[400px] overflow-hidden">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center text-white px-6 max-w-4xl">
                        ...
                        {#if post.excerpt}
                            <p
                                class="text-xl md:text-2xl text-white/90 leading-relaxed max-w-3xl mx-auto"
                            >
                                {post.excerpt}
                            </p>
                        {/if}
        ...
        {:else}
            <!-- No image hero -->
            <div class="bg-gradient-to-br from-gray-900 to-gray-800 py-20">
    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
        <!-- Article Meta -->
        <div
            class="flex flex-wrap items-center gap-4 mb-8 pb-8 border-b border-gray-200"
        >
            {#if post.category}
                <span
                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-accent/10 text-accent"
                >
                    {post.category}
                </span>
            {/if}
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    {#each relatedPosts as relatedPost}
                        <a
                            ...
                            class="block bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow group"
                        >
                            ...
                            {:else}
                                <div
                                    class="h-48 bg-gradient-to-br from-gray-200 to-gray-300 rounded-t-xl flex items-center justify-center"
                                >
                                    <svg
                            ...
                            <div class="p-6">
                                ...
                                {/if}
                                <h3
                                    class="text-xl font-semibold text-gray-900 mt-2 mb-3 group-hover:text-accent transition-colors"
                                >
                                    {relatedPost.title}
                                </h3>
...
{#if showShareButtons}
    <div
        class="fixed right-4 md:right-6 top-1/2 transform -translate-y-1/2 z-40"
    >
        <div class="flex flex-col gap-2 md:gap-3">
            <button
                on:click={shareOnTwitter}
                class="w-10 h-10 md:w-12 md:h-12 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors flex items-center justify-center"
            ...
            <button
                on:click={shareOnLinkedIn}
                class="w-10 h-10 md:w-12 md:h-12 bg-blue-700 text-white rounded-full hover:bg-blue-800 transition-colors flex items-center justify-center"
            ...
            <button
                on:click={copyToClipboard}
                class="w-10 h-10 md:w-12 md:h-12 bg-gray-600 text-white rounded-full hover:bg-gray-700 transition-colors flex items-center justify-center"
                title="Copy Link"
