	...
	<div class="mx-auto max-w-7xl">
		...
		<div class="mb-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
			...
			<div class="lg:col-span-1">
				<h3 class="mb-4 font-clash-grotesk text-[2rem] font-bold text-primary/80">TalkAfrica</h3>
				<p class="mb-6 text-sm leading-relaxed text-primary/50">
					Your premier destination for African news, culture, and innovation. Stay informed with the
					latest stories from across the continent.
				</p>
				<!-- Social Media Icons -->
				<div class="flex gap-4">
					<a
						href="https://facebook.com/talkafrica"
						class="text-primary/50 transition-colors duration-300 hover:text-accent"
						aria-label="Facebook"
					>
						<svg
							width="20"
					...
					<a
						href="https://instagram.com/talkafrica"
						class="text-primary/50 transition-colors duration-300 hover:text-accent"
					...
					<a
						href="https://youtube.com/talkafrica"
						class="text-primary/50 transition-colors duration-300 hover:text-accent"
						aria-label="YouTube"
					>
						<svg
					...
					<a
						href="https://twitter.com/talkafrica"
						class="text-primary/50 transition-colors duration-300 hover:text-accent"
						aria-label="Twitter"
					>
						<svg
			...
			<!-- News Categories -->
			<div>
				<h4 class="mb-4 font-clash-grotesk text-lg font-semibold">News</h4>
				<ul class="space-y-3">
					<li>
						<a
							href="/news"
			...
			<!-- Culture & Lifestyle -->
			<div>
				<h4 class="mb-4 font-clash-grotesk text-lg font-semibold">Culture</h4>
				<ul class="space-y-3">
					<li>
						<a
							href="/culture"
			...
			<div>
				<h4 class="mb-4 font-clash-grotesk text-lg font-semibold">Sports</h4>
				<ul class="space-y-3">
					<li>
						<a
							href="/sport"
		...
		<div class="mb-8 border-t border-tertiary/20 pt-8">
			<div class="max-w-md">
				<h4 class="mb-2 font-clash-grotesk text-lg font-semibold">Stay Updated</h4>
				<p class="mb-4 text-sm text-primary/50">
				...
				<form class="flex gap-2">
					<input
						...
						class="flex-1 rounded-md border border-tertiary/20 bg-primary/10 px-4 py-2 text-primary placeholder-tertiary focus:border-transparent focus:ring-2 focus:ring-accent focus:outline-none"
					/>
					<button
						type="submit"
						class="cursor-pointer rounded-md border border-accent bg-transparent px-6 py-2 font-medium text-accent"
					>
						Subscribe
					</button>
				</form>
		...
		<!-- Bottom Footer -->
		<div
			class="flex flex-col items-center justify-between gap-4 border-t border-tertiary/20 pt-8 md:flex-row"
		>
			<div class="flex flex-col items-center gap-4 text-sm text-primary/50 md:flex-row">
				<p>&copy; 2024 TalkAfrica. All rights reserved.</p>
				<div class="flex gap-6">
					<a href="/privacy" class="transition-colors duration-300 hover:text-accent"
						>Privacy Policy</a
					>
					<a href="/terms" class="transition-colors duration-300 hover:text-accent"
						>Terms of Service</a
					>
					<a href="/contact" class="transition-colors duration-300 hover:text-accent">Contact Us</a>
				</div>
			</div>
