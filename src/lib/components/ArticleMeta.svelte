...
<aside class="article-meta" aria-label="Article information">
    <div class="article-meta-info">
        {#if author}
            <div class="article-meta-group">
                <div class="article-meta-item">
                    ...
                    <span class="article-meta-value font-medium text-gray-900">{author}</span>
                </div>
                {#if editor}
                    <span class="article-meta-separator" aria-hidden="true">&bull;</span>
                    <div class="article-meta-item">
                        <span class="article-meta-label">Edited by</span>
                        <span class="article-meta-value font-medium text-gray-900">{editor}</span>
                    </div>
                {/if}
            </div>
        {/if}

        {#if author && (publishedDate || readingTime)}
            <span class="article-meta-separator main-separator" aria-hidden="true">&bull;</span>
        {/if}
        ...
        <div class="article-meta-group">
            ...
            {#if readingTime}
                <div class="article-meta-item">
                    <span class="article-meta-value">{formatReadingTime(readingTime)} read</span>
                </div>
            {/if}
        </div>
    </div>
...
<style>
    ...
    /* Mobile Optimization - Compact 2-line layout */
