<section class="mx-auto w-full max-w-[1900px] px-[var(--side-p)] py-[3rem]">
    ...
    <div class="flex flex-col lg:flex-row gap-10">
        ...
        <div class="flex flex-[1] flex-col gap-4">
            <div>
                <p
                    class="font-clash-grotesk text-[1.75rem] leading-tight font-semibold text-secondary"
                >
            ...
            <p
                class="text-[0.7rem] lg:text-[1rem] leading-relaxed text-secondary/80"
            >
                John Emmanuel Fagbemi stands at the intersection of culture,
                creativity, and impact. As a storyteller and media advocate, he
                is dedicated to reshaping Africa’s narrative by amplifying
                voices, preserving heritage, and promoting authentic content
                rooted in truth and identity. He is the founder and chief
                executive officer of TalkAfrica Nigeria, a visionary platform
                committed to showcasing African creativity and preserving
                cultural heritage. With a Bachelor’s degree in Music, John is
                also a talented saxophonist whose creativity flows seamlessly
                through both sound and storytelling. A passionate leader and
                communicator, he has received multiple awards in service, media,
                and humanitarian work, including recognitions from the Faculty
                of Arts at the Federal University Lokoja, the National
                Association of Kogi State Students, and several journalism
                development organizations. John is also a certified participant
                in the Pay Attention to Him Project, a Millennium Fellowship
                alumnus, a campus reporter at the Centre for Journalism
                Innovation and Development, and an associate of the Metropolitan
